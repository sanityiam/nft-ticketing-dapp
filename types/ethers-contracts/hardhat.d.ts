...
getContractFactory(name: 'TicketingPlatform', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.TicketingPlatform__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'TicketingPlatform', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.TicketingPlatform>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'TicketingPlatform', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.TicketingPlatform>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'TicketingPlatform', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.TicketingPlatform>
